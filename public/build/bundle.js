    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "piece circle svelte-lza8iz");
    			add_location(div0, file$1, 198, 1, 11382);
    			attr_dev(div1, "class", "inv-circle-section svelte-lza8iz");
    			add_location(div1, file$1, 202, 2, 11471);
    			attr_dev(div2, "class", "piece svelte-lza8iz");
    			add_location(div2, file$1, 201, 1, 11449);
    			attr_dev(div3, "class", "d svelte-lza8iz");
    			add_location(div3, file$1, 204, 1, 11519);
    			attr_dev(p0, "class", "top svelte-lza8iz");
    			add_location(p0, file$1, 208, 2, 11601);
    			attr_dev(p1, "class", "bottom svelte-lza8iz");
    			add_location(p1, file$1, 209, 2, 11623);
    			attr_dev(div4, "class", "piece rect svelte-lza8iz");
    			add_location(div4, file$1, 207, 1, 11574);
    			attr_dev(div5, "class", "lower-tri svelte-lza8iz");
    			add_location(div5, file$1, 214, 2, 11715);
    			attr_dev(div6, "class", "upper-tri svelte-lza8iz");
    			add_location(div6, file$1, 217, 2, 11782);
    			attr_dev(div7, "class", "piece svelte-lza8iz");
    			add_location(div7, file$1, 213, 1, 11693);
    			attr_dev(div8, "class", "flex justify-center items-center svelte-lza8iz");
    			add_location(div8, file$1, 197, 0, 11334);
    		},
    		l: function claim(nodes) {
