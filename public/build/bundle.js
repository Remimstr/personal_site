...
var app = (function () {
    ...
    /* public/assets/design.svg generated by Svelte v3.23.0 */
    ...
    /* src/cube.svelte generated by Svelte v3.23.0 */

    const file$1 = "src/cube.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div2 = element("div");
    			div0 = element("div");
    			div0.textContent = "Flip Me";
    			t1 = space();
    			div1 = element("div");
    			div1.textContent = "Oh you didn't";
    			t3 = space();
    			div3 = element("div");
    			div3.textContent = "Circle content";
    			attr_dev(div0, "class", "top svelte-r4e982");
    			add_location(div0, file$1, 59, 2, 2908);
    			attr_dev(div1, "class", "bottom svelte-r4e982");
    			add_location(div1, file$1, 62, 2, 2949);
    			attr_dev(div2, "class", "cube svelte-r4e982");
    			add_location(div2, file$1, 58, 1, 2887);
    			attr_dev(div3, "class", "circle svelte-r4e982");
    			add_location(div3, file$1, 66, 1, 3006);
    			add_location(div4, file$1, 57, 0, 2880);
    		},
    		l: function claim(nodes) {
    ...
    function instance$2($$self, $$props) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Cube> was created with unknown prop '${key}'`);
    	});
    ...
    const file$2 = "src/product-design.svelte";
    ...
    function create_fragment$8(ctx) {
    	...
    	let div6;
    	let current;
    	const pro$1 = new pro({ $$inline: true });
    	const d$1 = new d({ $$inline: true });
    	const uctde$1 = new uctde({ $$inline: true });
    	const sig$1 = new sig({ $$inline: true });
    	const ign$1 = new ign({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "piece circle svelte-iz7ng1");
    			add_location(div0, file$2, 172, 1, 8767);
    			attr_dev(div1, "class", "inv-circle-section svelte-iz7ng1");
    			add_location(div1, file$2, 176, 2, 8834);
    			attr_dev(div2, "class", "piece svelte-iz7ng1");
    			add_location(div2, file$2, 175, 1, 8812);
    			attr_dev(div3, "class", "d svelte-iz7ng1");
    			add_location(div3, file$2, 178, 1, 8877);
    			attr_dev(p0, "class", "top svelte-iz7ng1");
    			add_location(p0, file$2, 182, 2, 8937);
    			attr_dev(p1, "class", "bottom svelte-iz7ng1");
    			add_location(p1, file$2, 183, 2, 8956);
    			attr_dev(div4, "class", "piece rect svelte-iz7ng1");
    			add_location(div4, file$2, 181, 1, 8910);
    			attr_dev(div5, "class", "lower-tri svelte-iz7ng1");
    			add_location(div5, file$2, 188, 2, 9027);
    			attr_dev(div6, "class", "upper-tri svelte-iz7ng1");
    			add_location(div6, file$2, 191, 2, 9073);
    			attr_dev(div7, "class", "piece svelte-iz7ng1");
    			add_location(div7, file$2, 187, 1, 9005);
    			attr_dev(span, "class", "flex justify-center items-center");
    			add_location(span, file$2, 171, 0, 8718);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 28, 12, 865);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(28:6) <Typewriter interval={70}>",
    		ctx
    	});
    ...
    function create_fragment$9(ctx) {
    	...
    	const design$1 = new design({
    			props: {
    				id: "design-svg",
    				class: "display-block m-auto w-48 h-auto"
    			},
    			$$inline: true
    		});

    	const pro = new Product_design({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			t8 = space();
    			div1 = element("div");
    			create_component(design$1.$$.fragment);
    			t9 = space();
    			div2 = element("div");
    			create_component(pro.$$.fragment);
    			attr_dev(span0, "class", "font-semibold text-xl text-white tracking-tight mr-6");
    			add_location(span0, file$3, 15, 8, 471);
    			attr_dev(span1, "class", "ml-4");
    			add_location(span1, file$3, 18, 12, 610);
    			attr_dev(span2, "class", "ml-4");
    			add_location(span2, file$3, 19, 12, 655);
    			attr_dev(div0, "class", "block flex-grow");
    			add_location(div0, file$3, 17, 8, 568);
    			attr_dev(button, "class", "m");
    			add_location(button, file$3, 22, 8, 712);
    			attr_dev(nav, "class", "flex items-center justify-between flex-wrap text-white bg-orange-500 p-5");
    			add_location(nav, file$3, 14, 4, 376);
    			attr_dev(div1, "class", "w-full");
    			add_location(div1, file$3, 30, 8, 943);
    			attr_dev(div2, "class", "w-full");
    			add_location(div2, file$3, 33, 8, 1066);
    			attr_dev(div3, "class", "px-4 py-4 text-center");
    			add_location(div3, file$3, 26, 4, 784);
    			add_location(main, file$3, 13, 0, 365);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(typewriter, div3, null);
    			append_dev(div3, t8);
    			append_dev(div3, div1);
    			mount_component(design$1, div1, null);
    			append_dev(div3, t9);
    			append_dev(div3, div2);
    			mount_component(pro, div2, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    		...
    		i: function intro(local) {
    			...
    			transition_in(design$1.$$.fragment, local);
    			transition_in(pro.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(typewriter.$$.fragment, local);
    			transition_out(design$1.$$.fragment, local);
    			transition_out(pro.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(main);
    			destroy_component(typewriter);
    			destroy_component(design$1);
    			destroy_component(pro);
    		}
    	};
