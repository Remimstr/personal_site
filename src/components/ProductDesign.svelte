...
<div class="flex justify-center items-center">
  ...
  <div class="piece">
    <div
      class="inv-circle-section"
      class:inv-circle-section-transformed={!hasBeenVisited}
    />
  </div>
  ...
  <div
    class="piece"
    class:rect={!hasBeenVisited}
    class:plain-rect={hasBeenVisited}
  >
    <div class:top={!hasBeenVisited} />
...
<style>
  ...
  .inv-circle-section {
    ...
    background: radial-gradient(
      circle closest-corner at calc(var(--border-width) * -6) 50%,
  ...
  .inv-circle-section-transformed {
    animation: inv-circle-rotate 1s 1s;
  }
  ...
  .top {
    ...
    background: repeating-linear-gradient(45deg, lightcoral 10px, white 20px);
  }
  .bottom {
    height: var(--height);
    border: var(--border-width) red solid;
  ...
  .upper-tri-transformed {
    ...
    animation: upper-tri-rotate 1s 1s;
    animation-fill-mode: forwards;
  }
  ...
  .lower-tri-transformed {
    ...
    animation: rotate-lower-tri 1s 1s;
    animation-fill-mode: forwards;
  }
